{strip}
    ...
    <div class="sec-holder" {if $parameters.user->user_type == "Buyer"}style="padding-top: 0;"{/if}>
            ...
            <div class="t1-top-panel-instance">
                <div class="top-panel-auction">
                    <div class="container">
                        <div class="content">
                            <h2 class="title">
                                <span style="color: #0650cb;">{$parameters.auction_info->year}</span><span
                                        class="mark"> {$parameters.auction_info->make} {$parameters.auction_info->model}&nbsp;</span> {$parameters.auction_info->trim}
                                &nbsp;{$parameters.auction_info->trim2}
                            </h2>
                            {if $parameters.auction_info->auction_status == "Completed" && $parameters.auction_info->auction_fake_winning_bid != "N/A"}
                                <div class="button-read green fake-link"
                                     data-link="/auctions/{$parameters.auction_info->id}/bill/">
                                    <div class="ico">
                                        <img class="svg-icon-inject" src="/images/icons/icon-bill.svg" alt="bill"
                                             title="bill"/>
                                    </div>
                                    read bill of sale
                                </div>
                                <div class="mobile-fixed-panel only-show-on-mobile">
                                    <div class="holder">
                                        <div class="btn read fake-link"
                                             data-link="/auctions/{$parameters.auction_info->id}/bill/">
                                            <div class="holder">
                                                <div class="ico">
                                                    <img class="svg-icon-inject" src="/images/icons/icon-bill.svg"
                                                         alt="bill" title="bill"/>
                                                </div>
                                                <span class="describe">
                                            ...
                                            <div class="buttons-box">
                                                ...
                                                <div class="btn green">
                                                                <span class="describe">
                                                                    ...
                                                                    <strong class="val big {if $parameters.auction_info->expiration_date_main > 0}timer{/if}"
                                                                            data-started=""
                                                                            data-left="{$parameters.auction_info->expiration_date_main}">{if $parameters.auction_info->expiration_date_main < 0}00:00:00{/if}</strong>
                                                                    <span class="det">{$parameters.auction_info->expiration_date|date_format:"%b %d, %Y %I:%M:%S %Z"}</span>
                                                                </span>
                                                </div>
                                                <div class="btn">
                                                    <div class="holder blue fake-link"
                                                         data-link="/auctions/{$parameters.auction_info->id}/edit/">
                                                                    <span class="describe">
                                                                        <strong class="val big">edit</strong>
                                                                    </span>
                                                        <span class="sep"></span>
                                                        <div class="ico">
                                                            <img class="svg-icon-inject"
                                                                 src="/images/icons/icon-edit.svg" alt="edit"
                                                                 title="edit"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="btn">
                                                    <div class="holder red">
                                                        <a class="link-box" id="quick_bid_top_cancle" data-number="4" href="javascript:cancleAuction({$parameters.auction_info->id})"></a>
                                                        <span class="describe">
                                                                        <strong class="val big">cancel</strong>
                                                                    </span>
                                                        <span class="sep"></span>
                                                        <div class="ico">
                                                            <img class="svg-icon-inject" src="/images/icons/cancel.svg"
                                                                 alt="edit" title="edit"/>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="holder">
                                            ...
                                            <div class="btn green">
                                                            <span class="describe">
                                                                ...
                                                                <strong class="val big {if $parameters.auction_info->expiration_date_main > 0}timer{/if}"
                                                                        data-started=""
                                                                        data-left="{$parameters.auction_info->expiration_date_main}">{if $parameters.auction_info->expiration_date_main < 0}0:00:00{/if}</strong>
                                                                <span class="det">{$parameters.auction_info->expiration_date|date_format:"%b %d, %Y %I:%M:%S %Z"}</span>
                                                            </span>
                                            </div>
                                                ...
                                                <div class="holder blue fake-link"
                                                    ...
                                                    <div class="ico change">
                                                        <img class="svg-icon-inject"
                                                             ...
                                                             alt="pencil-edit-button" title="pencil-edit-button"/>
                                                        <img class="svg-icon-inject" src="/images/icons/cancel.svg"
                                                ...
                                                <div>
                                                    <form action="" method="POST" id="mobile-cancel-auction-form">
                                                        ...
                                                        <input type="hidden" name="auction_id"
                                                               value="{$parameters.auction_info->id}">
                                                        ...
                                                        <p id="mobile-cancel-auction-err"
                                                           style="display:none; color:red; padding:0; margin:0;"></p>
                                                        <p class="desc">Are you sure you wish to cancel this
                                                            auction?</p>
                                                        <div class="center-buttons">
                                                            <button type="button"
                                                                    class="btn-2 black close-it close-mob-bid-input"
                                                                    id="close-mobile-popup-cancel">No, nevermind
                                                            </button>
                                                            <br/>
                                                            <button type="button" class="btn-2 red"
                                                                    id="mobile-popup-cancel-yes">Yes, cancel auction
                                                            </button>
                                                        </div>
                                                    </form>
                                                </div>
                                    ...
                                    <div class="container">
                                        <div class="container">
                                            <div class="content mob-t-p-0">
                                                        ...
                                                        {if $parameters.auction_info->photos}
                                                            <div id="slider-car" class="slider-car">
                                                                {foreach from=$parameters.auction_info->photos item=item}
                                                                    <div class="slide">
                                                                        <a id="desktop-image" class="auction-details-photo swipebox" href="/site_media/{$item->photo}/bd/" data-caption="{$item->title}" title="View Image">
                                                                            <div class="img" style="background-image: url('/site_media/{$item->photo}/bd/');background-color: #000000;background-repeat: no-repeat;background-size: contain;" alt="{$item->title}"></div>
                                                                        </a>
                                                                    </div>
                                                                {/foreach}
                                                            </div>
                                                            ...
                                                            <div class="item i-3 mob-i-3">
                                                                <div class="box padding">
                                                                    <div class="inner">
                                                                        ...
                                                                        <div class="value blue">
                                                                            {if $parameters.flag_discount == 1}
                                                                                {if $parameters.auction_info->buy_now_price > 0}<del style="color:red;">${$parameters.auction_info->this_price|money_format}</del>  ${$parameters.auction_info->buy_now_price|money_format}{else}N/A{/if}
                                                                            {else}
                                                ...
                                                <!-- button Unsold -->
                                                {if $parameters.auction_info->auction_status != "Sold" && intval($parameters.button_unsold) === 1}
                                                ...
                                                <div class="info-section alt">
                                                    ...
                                                    <div class="section-box-2">
                                                        <div class="info-box"  style="margin-top: 15px;">
                                                            ...
                                                            <div class="holder">
                                                                <p>{$parameters.auction_info->description|nl2br}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    {/if}
                                                        ...
                                                        <div class="table-row">
                                                            <div class="cell " data-number="2">
                                                                <div class="item">
                                                                                <span class="ico left">
                                                                                    <img class="svg-icon-inject"
                                                                                         src="/images/icons/icon-timestamp.svg"
                                                                                         alt="TimeStamp"
                                                                                         title="TimeStamp"/>
                                                                                </span>
                                                                    <em>TimeStamp</em>
                                                            ...
                                                            <div class="cell " data-number="3">
                                                                <div class="item">
                                                                                <span class="ico left">
                                                                                    <img class="svg-icon-inject"
                                                                                         src="/images/icons/icon-amount.svg"
                                                                                         alt="Amount" title="Amount"/>
                                                                                </span>
                                                                    <em>Amount</em>
                                                                </div>
                                                            </div>
                                                            <div class="cell " data-number="4">
                                                                <div class="item">
                                                                                <span class="ico left">
                                                                                    <img class="svg-icon-inject"
                                                                                         src="/images/icons/icon-location-4.svg"
                                                                                         alt="Location"
                                                                                         title="Location"/>
                                                                                </span>
                                                                    <em>Location</em>
                                                        ...
                                                        {foreach from=$parameters.auctions_bids item=bid}
                                                            <div class="table-row {if $bid->winning_bid == 1}new{/if}  ">
                                                                <div class="cell" data-number="2" data-text="timestamp">
                                                                    <div class="el" style="color: #272727;">{$bid->datetime_create|date_format:"%b %d, %Y %I:%M:%S %Z"}</div>
                                                                </div>
                                                                <div class="cell" data-number="3" data-text="amount">
                                                                    <div class="el" style="color: #272727;">US&nbsp;
                                                                        ${$bid->bid_price|money_format}</div>
                                                                </div>
                                                                <div class="cell {if !$bid->location}no-user-location{/if}"
                                                                     data-number="4" data-text="Location">
                                                                    <div class="el" style="color: #272727;">{$bid->location}</div>
                                                                </div>
                                                            </div>
                                                        {/foreach}
                                                    </div>
        ...
        {elseif ($parameters.auction_info->auction_status == "Sold" || $parameters.auction_info->auction_status == "Completed" || $parameters.auction_info->auction_status == "Canceled" || $parameters.auction_info->auction_status == "Expired")}
                                            ...
                                            <div class="container">
                                                <div class="content content-unavailable">
                                                    <div class="module-sold-bid">
                                                        ...
                                                        <button type="button" class="btn-2 blue fake-link"
                                                                data-link="/auctions/">browse all auctions
                                                        </button>
                                                        <figure class="img-holder img-holder-cus">
                                                            <img class="svg-icon-inject"
                                                                 src="/images/icons/icon-unavailable-2.svg"
                                                                 alt="browse all auctions" title="browse all auctions"/>
                                                        </figure>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="content ">
                                                    <div class="module-intro-box">
                                                        <div class="img-holder"
                                                             style="background-image: url('/site_media/{$item->photo}/bd/');background-color: #fff;background-repeat: no-repeat;background-size: contain;"
                                                             alt="{$item->title}">
                                                            <span></span>
                                                            {if $parameters.auction_info->auction_status == "Completed" && $parameters.auction_info->auction_fake_winning_bid != "N/A"}
                                                                <div class="soldout">sold</div>
                                                            ...
                                                            {if $parameters.auction_info->photos}
                                                                <div id="slider-car" class="slider-car">
                                                                    {foreach from=$parameters.auction_info->photos item=item}
                                                                        <div class="slide">
                                                                            <a id="desktop-image"
                                                                               class="auction-details-photo swipebox"
                                                                               href="/site_media/{$item->photo}/bd/"
                                                                ...
                                                                {if $photosCount > 1}
                                                                    <div id="next-prev-arrow">
                                                                        <span id="prev-slide" class="prev-slide">
                                                                          <img class="svg-icon-inject" src="/images/arrows/icon-arrow-p.svg" alt="prev slide" title="prev slide"/>
                                                                        </span>
                                                                        <span id="next-slide" class="next-slide">
                                                                          <img class="svg-icon-inject" src="/images/arrows/icon-arrow-n.svg" alt="next slide" title="next slide"/>
                                                                        </span>
                                                                    </div>
                                                                {/if}
                                                            {else}
                                                                <div class="slider-car slider-car-no-photo">
                                                                    <div class="slide">
                                                                        <div class="img"
                                                                             style="background-image: url('/images/default-car-image.png');background-color: #e3e3e3;"
                                                                             alt="{$item->title}"
                                                        ...
                                                        <div class="text grid-options">
                                                                ...
                                                                <div class="box padding">
                                                                    <div class="inner">
                                                                        <h2 class="title-main"><span
                                                                                    class="mark">{$parameters.auction_info->year} {$parameters.auction_info->make} {$parameters.auction_info->model}&nbsp;</span><em>{$parameters.auction_info->trim} {$parameters.auction_info->trim2}</em>
                                                                        </h2>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="item i-2 mob-i-1">
                                                                <div class="box padding">
                                                                    <div class="inner">
                                                                        ...
                                                                        <div class="value blue">
                                                                            {if $parameters.auction_info->auction_completion_date}
                                                                                {$parameters.auction_info->auction_completion_date|date_format:"%b %d, %Y"}
                                                                                <span class="divider"> | </span>
                                                                                {$parameters.auction_info->auction_completion_date|date_format:"%I:%M:%S %Z"}
                                                                            {else}
                                                                                {$parameters.auction_info->expiration_date|date_format:"%b %d, %Y"}
                                                                                <span class="divider"> | </span>
                                                                                {$parameters.auction_info->expiration_date|date_format:"%I:%M:%S %Z"}
                                                                            {/if}
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="item i-2 mob-i-1">
                                                                <div class="box padding">
                                                                    <button class="btn-2 black stretch-btn fake-link"
                                                                            data-link="/seller/{$parameters.seller_info->url_title}/">
                                                                        view all seller auctions
                                                                    </button>
                                                                </div>
                                                            </div>
                                                        </div>
                        ...
                        <div class="content">
                            ...
                            {if $parameters.auction_info->auction_status == "Active" && !isset($smarty.session.user)}
                                <div class="btn place-bid">
                                    <div class="holder red">
                                        <a class="link-box" id="quick_bid_top" data-number="5" href="javascript:void(0);"></a>
                                        <span class="describe">
                                                            <strong class="val big">place bid</strong>
                                                        </span>
                                        <span class="sep"></span>
                                        <div class="ico">
                                            <img class="svg-icon-inject" src="/images/icons/play-button.svg"
                                                 alt="Place Bid" title="Place Bid"/>
                                        </div>
                                    </div>
                                </div>
                            {/if}
                                        ...
                                        <div class="buttons">
                                            <div class="input-holder-box">
                                                <div class="buttons-box">
                                                    ...
                                                    {if ($parameters.auction_info->sell_to == 1) || $parameters.auction_info->sell_to == 2}
                                                        <div class="btn">
                                                            <div class="holder red">
                                                                <div class="link-box popup" data-number="1"
                                                                ...
                                                                <div class="ico">
                                                                    <img class="svg-icon-inject"
                                                                         src="/images/icons/play-button.svg" alt="Bid"
                                                                         title="Bid"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="field-block-1">
                                                            <div class="flex">
                                                                <input type="text" class="text"
                                                                       placeholder="Enter US $30,050 or more"/>
                                                                <div class="btn blue">
                                                                    <div class="ico">
                                                                        <img class="svg-icon-inject"
                                                                             src="/images/icons/racquet.svg" alt="Bid"
                                                                             title="Bid"/>
                                                                    </div>
                                                                    <span class="describe">
                                                        ...
                                                        <div class="holder red">
                                                            ...
                                                            <div class="ico change">
                                                                <img class="svg-icon-inject"
                                                                     ...
                                                                     title="Bid"/>
                                                                <img class="svg-icon-inject"
                                                                     src="/images/icons/cancel.svg" alt="cancel"
                                                                     title="cancel"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                {else}
                                                    <div class="btn custom-grey-btn">
                                                        <div class="holder grey"
                                                             id="mobile-place-bid-dealer-only-auction">
                                                                            <span class="describe">
                                                                                <strong class="val big">PLACE BID</strong>
                                                                            </span>
                                                            <span class="sep"></span>
                                                    ...
                                                    <div>
                                                        <form action="" id="mobile_popup_place_bid_form">
                                                            <input type="hidden" name="action"
                                                                   value="mobile-popup-place-bid">
                                                            <input type="hidden" name="auction_id"
                                                                   value="{$parameters.auction_info->id}">
                                                            <label class="title-bid">Enter Amount</label>
                                                            <div class="input-bid-holder">
                                                                <span>$</span>
                                                                <input name="mobile_popup_bid_price" id="txt" type="tel"
                                                                       class="bid-input-field custom-number"
                                                                       placeholder="0"/>
                                                            </div>
                                                            {if $parameters.auction_info->count_bids == "0"}
                                                            ...
                                                            {/if}
                                                            <div class="desc">Enter ${$nextMinimumBid|money_format} or more
                                                            </div>
                                                            <p id="mobile_popup_place_bid_form_err"
                                                               style="display: none;"></p>
                                                            <button type="button"
                                                                    class="btn-2 place-bid-grey mobile-popup-place-bid-btn-2"
                                                                    data-number="7">place bid
                                                            </button>
                                                        </form>
                                                            ...
                                                            {if ($parameters.user->buyer_type == "Dealer" && $parameters.auction_info->sell_to == 1) || $parameters.auction_info->sell_to == 2}
                                                                {if $parameters.auction_info->buy_now_price > 0 && $parameters.auction_info->current_bid_price < $parameters.auction_info->buy_now_price}
                                                                    ...
                                                                    <form method="POST" action=""
                                                                          id="mobile_popup_buy_now_form">
                                                                        <input type="hidden" name="action"
                                                                               value="buy_now">
                                                                        <input type="hidden" name="auction_id"
                                                                               value="{$parameters.auction_info->id}">
                                                                        <input type="hidden"
                                                                               name="mobile_buy_now_for_price"
                                                                               value="{$parameters.auction_info->buy_now_price|money_format}">
                                                                    ...
                                                                    <div class="price-tip">
                                                                        ${$parameters.auction_info->buy_now_price|money_format}</div>
                                                                {/if}
                                                            {/if}
                                                        {/if}
                                                    </div>
                            ...
                            {if $parameters.auction_info->auction_status == "Completed"}
                                {if $parameters.auction_info->winning_user_id == $parameters.user->id}
                                    <div class="button-read green fake-link"
                                        ...
                                        <div class="ico">
                                            <img class="svg-icon-inject" src="/images/icons/icon-bill.svg"
                                                 alt="read bill of sale" title="read bill of sale"/>
                                        </div>
                                        read bill of sale
                                    </div>
                                    <div class="mobile-fixed-panel only-show-on-mobile">
                                            ...
                                            <div class="left-contentbox">
                                                <div class="img-holder">
                                                    <div class="holder no-overlay">
                                                        <img src="{if $parameters.seller_info->profile_photo}/site_media/{$parameters.seller_info->profile_photo}/md/{else}/images/default-user-image.png{/if}"
                                                             alt="{$parameters.seller_info->name}"
                                                             title="{$parameters.seller_info->name}"/>
                                                    </div>
                                                </div>
                                                <h4 class="name">
                                                ...
                                                <div class="seller-info">
                                                    {if $parameters.seller_info->zip != "" || $parameters.seller_info->city != "" || $parameters.seller_info->state != ""}
                                                        <div class="item">
                                                            <div class="ico">
                                                                <img class="svg-icon-inject"
                                                                     src="/images/icons/icon-location-2.svg"
                                                    ...
                                                    <div class="item">
                                                        <div class="ico">
                                                            <img class="svg-icon-inject"
                                                                 src="/images/icons/icon-miles.svg" alt="distance"
                                                                 title="distance"/>
                                                        </div>
                                                    ...
                                                    {if isset($smarty.session.user) && $parameters.user->user_type == "Buyer"}
                                                        <div class="btn"  style="margin:10px 0px 0px; width : 100%; padding:0px;">
                                                            <a class="btn-2 black" style="padding: 20px 19px;"
                                                               href="/seller/{$parameters.seller_info->url_title}/"
                                                               title="SEE ALL {$parameters.seller_info->name|escape} VEHICLES FOR SALE">SEE ALL {$parameters.seller_info->name|escape} VEHICLES FOR SALE </a>
                                                        </div>
                                                    {/if}
                                                </div>
                                            </div>
                    ...
                    <div class="sec-2">
                        <div class="baron">
                            <div class="baron__clipper">
                                ...
                                <div class="baron__scroller">
                                    <div class="content-box">
                                        <div class="auction-detail" id="auction-buyer">
                                            <div class="content">
                                                <div class="module-intro-box">
                                                    <div class="col-sm-6">
                                                        <div class="animation-small-load img-holder {if $parameters.auction_info->photos}slider{/if}">
                                                            <span class="absolute-year">{$parameters.auction_info->year}</span>
                                                            {if $parameters.auction_info->photos}
                                                                <div class="anim lds-ring">
                                                                    <div></div>
                                                                    <div></div>
                                                        ...
                                                        <div class="property-list mob-3 last first">
                                                            {if $parameters.auction_info->vin_number && (isset($smarty.session.user) || $parameters.user->user_type == "Seller" && $parameters.user->id != $parameters.auction_info->user_id)}
                                                                <div class="item">
                                                                    <div class="icon">
                                                                        <img class="svg-icon-inject"
                                                                             src="/images/icons/icon-vin-number.svg"
                                                                             alt="vin number" title="vin number"/>
                                                                    </div>
                                                                    <div class="text">
                                                                        <h5 class="title">vin number</h5>
                                                                        {$parameters.auction_info->vin_number}
                                                            ...
                                                            {if $parameters.auction_info->engine}
                                                                <div class="item">
                                                                    <div class="icon">
                                                                        <img class="svg-icon-inject"
                                                                             src="/images/icons/icon-engine.svg"
                                                            ...
                                                            {if $parameters.auction_info->trim}
                                                                <div class="item">
                                                                    <div class="icon">
                                                                        <img class="svg-icon-inject"
                                                                             src="/images/icons/icon-trim.svg"
                                                                             alt="trim" title="trim"/>
                                                                    </div>
                                                                    <div class="text">
                                                                        <h5 class="title">trim</h5>
                                                            ...
                                                            {if $parameters.auction_info->mpg}
                                                                <div class="item">
                                                                    <div class="icon">
                                                                        <img class="svg-icon-inject"
                                                                             src="/images/icons/icon-mpg.svg" alt="MPG"
                                                                             title="MPG"/>
                                                                    </div>
                                                                    <div class="text">
                                                                        <h5 class="title">MPG</h5>
                                                            ...
                                                            {if $parameters.auction_info->mileage}
                                                                <div class="item">
                                                                    <div class="icon">
                                                                        <img class="svg-icon-inject"
                                                                             src="/images/icons/icon-mileage.svg"
                                                                             alt="mileage" title="mileage"/>
                                                                    </div>
                                                                    <div class="text">
                                                                        <h5 class="title">mileage</h5>
                                                                        {$parameters.auction_info->mileage|money_format}
                                                            ...
                                                            {if $parameters.auction_info->number_of_cylinders}
                                                                <div class="item">
                                                                    <div class="icon">
                                                                        <img class="svg-icon-inject"
                                                                             src="/images/icons/icon-cylinder.svg"
                                                                             alt="number of cylinders"
                                                            ...
                                                            {if $parameters.auction_info->auction_condition}
                                                                <div class="item">
                                                                    <div class="icon">
                                                                        <img class="svg-icon-inject"
                                                                             src="/images/icons/icon-condition.svg"
                                                            ...
                                                            {if $parameters.auction_info->transmission}
                                                                <div class="item">
                                                                    <div class="icon">
                                                                        <img class="svg-icon-inject"
                                                                             src="/images/icons/icon-transmission.svg"
                                                                             alt="transmission" title="transmission"/>
                                                                    </div>
                                                                    <div class="text">
                                                                        <h5 class="title">transmission</h5>
                                                                        {$parameters.auction_info->transmission}
                                                            ...
                                                            {if $parameters.auction_info->fuel_type}
                                                                <div class="item">
                                                                    <div class="icon">
                                                                        <img class="svg-icon-inject"
                                                                             src="/images/icons/icon-fuel-type.svg"
                                                                             alt="fuel type" title="fuel type"/>
                                                                    </div>
                                                                    <div class="text">
                                                                        <h5 class="title">fuel type</h5>
                                                                        {$parameters.auction_info->fuel_type}
                                                            ...
                                                            {if $parameters.auction_info->options}
                                                                <div class="item">
                                                                    <div class="icon">
                                                                        <img class="svg-icon-inject"
                                                                             src="/images/icons/icon-options.svg"
                                                                             alt="options" title="options"/>
                                                                    </div>
                                                                    <div class="text">
                                                                        <h5 class="title">options</h5>
                                                                        {$parameters.auction_info->options}
                                                            ...
                                                            {if $parameters.auction_info->number_of_doors}
                                                                <div class="item">
                                                                    <div class="icon">
                                                                        <img class="svg-icon-inject"
                                                                             src="/images/icons/icon-car-doors.svg"
                                                                             alt="number of doors"
                                                            ...
                                                            {if $parameters.auction_info->title_status}
                                                                <div class="item">
                                                                    <div class="icon">
                                                                        <img class="svg-icon-inject"
                                                                             src="/images/icons/icon-title.svg"
                                                                             alt="Title status" title="Title status"/>
                                                                    </div>
                                                                    <div class="text">
                                                                        <h5 class="title">Title status</h5>
                                                                        {if $parameters.auction_info->title_status}{$parameters.auction_info->title_status}{else}Clear{/if}
                                                            ...
                                                            {if $parameters.auction_info->drive_type}
                                                                <div class="item">
                                                                    <div class="icon">
                                                                        <img class="svg-icon-inject"
                                                                             src="/images/icons/icon-mpg.svg"
                                                                             alt="Drive Type" title="Drive Type"/>
                                                                    </div>
                                                                    <div class="text">
                                                                        <h5 class="title">Drive Type</h5>
                                                                        {$parameters.auction_info->drive_type}
                                                    ...
                                                    <div class="col-sm-6 right-action">
                                                        ...
                                                        <div class="bid-action">
                                                            <div style="width: 100%; display: inline-block;">
                                                                <div class="b-left">
                                                                                <span>MAXIMUM PROXY | {if $parameters.auction_info->user_maximum_proxy_bid_on_auction != ""}
                                                                                        ${$parameters.auction_info->user_maximum_proxy_bid_on_auction|money_format}
                                                                                    {else}
                                                                                        N/A
                                                                                    {/if}</span>
                                                                    <span class="{if $parameters.auction_info->you_are_winner == true}div-green{else}div-red{/if}">{if $parameters.auction_info->you_are_winner == true}HIGH BIDDER{else}GET BIDDING{/if}</span>
                                                                </div>
                                                                <div class="b-right">
                                                                    <span>NEXT MIN BID | ${if $parameters.auction_info->current_bid_price != 0}{$parameters.auction_info->current_bid_price+50|money_format}{else}{$nextMinimumBid|money_format}{/if}</span>
                                                                    <span><div class="{if $parameters.auction_info->winner_id == ''}div-red{elseif $parameters.auction_info->current_bid_price >= $parameters.auction_info->reserve_price}div-green{else}div-yellow{/if}">{if $parameters.auction_info->current_bid_price >= $parameters.auction_info->reserve_price && $parameters.auction_info->winner_id != ''}Reserve Met{else}RESERVE NOT MET{/if}</div></span>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div style="text-align: center;    margin-top: 20px;margin-bottom: 20px;">
                                                                <form class="form" action="" id="place_bid_form">
                                                                    ...
                                                                    <input style="     text-align: right;font-size: 20px;"
                                                                           name="bid_price" type="tel"
                                                                           class="text custom-number inp-dollar"
                                                                           placeholder="Enter ${$nextMinimumBid|money_format} or more..."/>
                                                                    <div class="btn-2 page-bid-price2 blue popup"
                                                                         data-number="6">
                                                                        <span class="name">PLACE BID</span>
                                                                    </div>
                                                                </form>
                                                            </div>


                                                            <form class="form form-quick-bid" action=""
                                                                  id="place_quick_bid_form">
                                                                <input type="hidden" name="action"
                                                                       value="place-quick-bid">
                                                                <input type="hidden" name="auction_id"
                                                                       value="{$parameters.auction_info->id}">
                                                                <input type="hidden" name="quick_bid"
                                                                       value="{$nextMinimumBid|money_format}">
                                                                <div class="box padding text-center icon-right quick-bid-button popup"
                                                                     data-number="8">
                                                                    <div class="inner">
                                                                        <h5 class="title-big">QUICK BID ${if $parameters.auction_info->current_bid_price != 0}{$parameters.auction_info->current_bid_price+50|money_format}{else}{$nextMinimumBid|money_format}{/if}</h5>
                                                                        {*<div class="det">${$nextMinimumBid|money_format}</div>*}
                                                                    </div>
                                                                </div>
                                                            </form>
                                                            {if $parameters.auction_info->current_bid_price >= $parameters.auction_info->reserve_price && $parameters.auction_info->winner_id != ''}
                                                            {else}
                                                                {if ($parameters.user->user_type == "Buyer" || $parameters.auction_info->user_id != $parameters.user->id) && $parameters.auction_info->auction_status == "Active"}
                                                                    {if ($parameters.auction_info->sell_to == 1) || $parameters.auction_info->sell_to == 2}
                                                                        {if $parameters.auction_info->buy_now_price > 0 && $parameters.auction_info->current_bid_price < $parameters.auction_info->buy_now_price}
                                                                            ...
                                                                            <form method="POST" action=""
                                                                                ...
                                                                                <div class="btn-buy submit-mobile-popup-buy-now">
                                                                                    ...
                                                                                    <div class="price-tip">
                                                                                      {if $parameters.flag_discount == 1}
                                                                                          <del style="color:red;">${$parameters.auction_info->this_price|money_format}</del> ${$parameters.auction_info->buy_now_price|money_format}
                                                                                      {else}
                                                                                          ${$parameters.auction_info->buy_now_price|money_format}
                                                                                      {/if}
                                                                                    </div>
                                                                                </div>
                                                                            </form>
                                                        ...
                                                        <div class="b-footer">
                                                            <div class="col-sm-2">
                                                                <div class="view-bid">
                                                                    <div>
                                                                        <span>#BIDS</span>
                                                                        <span>{$parameters.auction_info->count_bids}</span>
                                                                    </div>
                                                                    <div>
                                                                        <span>#VIEWS</span>
                                                                        <span>{$parameters.auction_info->count_view}</span>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-sm-10">
                                                                <div class="performance-box text grid-options uship">
                                                                    <div class="uship-body">
                                                                        <div class="logo-uship">
                                                                            <img src="/images/UShip_logo.png"
                                                                                 style="    width: 100px;">
                                                                        </div>
                                                                        <input type="hidden" name="user_id"
                                                                               value="{$parameters.user->id}">
                                                                        <div id="uship-content">
                                                                            <img src="/js/libs/swipebox/img/loader.gif">
                                                                        </div>
                                                                    </div>
                                                                                ...
                                                                                <div class="right">
                                                                                    ...
                                                                                    <span class="ico">
                                                                                        <img class="svg-icon-inject"
                                                                                            ...
                                                                                            <em class="star star-detail-page{if in_array($parameters.auction_info->id, $parameters.user_watched)} active{/if}"
                                                                                                record-id="{$parameters.auction_info->id}">{if in_array($parameters.auction_info->id, $parameters.user_watched)} remove from favorites{else}add to favorites{/if}</em>
                                                                                        </div>
                                                                                        <div class="item">
