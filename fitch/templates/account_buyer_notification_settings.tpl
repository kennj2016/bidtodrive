                                            ...
                                            <form action="#" id="notification-form" class="form" autocomplete="off">
                                                <div class="flexbox full-width mob-block">
                                                    <div class="bigitem-flex label-holder">
                                                        <div class="setting">Notify me of watched listings expiring</div>
                                                    </div>
                                                    <div class="smallitem-toggle flex-v-center flex-h-center">
                                                        <div class="toggle_radio no-borders">
                                                            <input type="radio" {if $parameters.user->notification_type_4 == 1}checked {/if} class="toggle_option first" id="notification_type_41" name="notification_type_4" value="1">
                                                            <label for="notification_type_41"><span>On</span></label>
                                                            <input type="radio" {if $parameters.user->notification_type_4 == 0}checked {/if} class="toggle_option second" id="notification_type_40" name="notification_type_4" value="0">
                                                            <label for="notification_type_40"><span>Off</span></label>
                                                ...
                                                <div class="flexbox full-width mob-block">
                                                    <div class="bigitem-flex label-holder">
                                                        <div class="setting">Notify me when I win an auction</div>
                                                    </div>
                                                    <div class="smallitem-toggle flex-v-center flex-h-center">
                                                        <div class="toggle_radio no-borders">
                                                            <input type="radio" {if $parameters.user->notification_type_2 == 1}checked {/if} class="toggle_option first" id="notification_type_21" name="notification_type_2" value="1" />
                                                            <label for="notification_type_21"><span>On</span></label>
                                                            <input type="radio" {if $parameters.user->notification_type_2 == 0}checked {/if} class="toggle_option second" id="notification_type_20" name="notification_type_2" value="0" />
                                                            <label for="notification_type_20"><span>Off</span></label>
                                                            <div class="toggle_option_slider"><span></span></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="flexbox full-width mob-block">
                                                    <div class="bigitem-flex label-holder">
                                                        <div class="setting">Notify when me when I am outbid on an auction</div>
                                                    </div>
                                                    <div class="smallitem-toggle flex-v-center flex-h-center">
                                                        <div class="toggle_radio no-borders">
                                                            <input type="radio" {if $parameters.user->notification_type_7 == 1}checked {/if} class="toggle_option first" id="notification_type_71" name="notification_type_7" value="1" />
                                                            <label for="notification_type_71"><span>On</span></label>
                                                            <input type="radio" {if $parameters.user->notification_type_7 == 0}checked {/if} class="toggle_option second" id="notification_type_70" name="notification_type_7" value="0" />
                                                            <label for="notification_type_70"><span>Off</span></label>
                                                            <div class="toggle_option_slider"><span></span></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="flexbox full-width mob-block">
                                                    <div class="bigitem-flex label-holder">
                                                        <div class="setting">Notify me when a Watched Seller lists a new auction</div>
                                                    </div>
                                                    <div class="smallitem-toggle flex-v-center flex-h-center">
                                                        <div class="toggle_radio no-borders">
                                                            <input type="radio" {if $parameters.user->notification_type_8 == 1}checked {/if} class="toggle_option first" id="notification_type_81" name="notification_type_8" value="1" />
                                                            <label for="notification_type_81"><span>On</span></label>
                                                            <input type="radio" {if $parameters.user->notification_type_8 == 0}checked {/if} class="toggle_option second" id="notification_type_80" name="notification_type_8" value="0" />
                                                            <label for="notification_type_80"><span>Off</span></label>
                                                            <div class="toggle_option_slider"><span></span></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="flexbox full-width mob-block">
                                                    <div class="bigitem-flex label-holder">
                                                        <div class="setting">Notify me when I make a bid</div>
                                                    </div>
                                                    <div class="smallitem-toggle flex-v-center flex-h-center">
                                                        <div class="toggle_radio no-borders">
                                                            <input type="radio" {if $parameters.user->notification_type_18 == 1}checked {/if} class="toggle_option first" id="notification_type_181" name="notification_type_18" value="1" />
                                                            <label for="notification_type_81"><span>On</span></label>
                                                            <input type="radio" {if $parameters.user->notification_type_18 == 0}checked {/if} class="toggle_option second" id="notification_type_180" name="notification_type_18" value="0" />
                                                            <label for="notification_type_180"><span>Off</span></label>
                                                            <div class="toggle_option_slider"><span></span></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="flexbox full-width mob-block">
                                                    <div class="bigitem-flex label-holder">
                                                        <div class="setting">Warn me when my credit card is expiring</div>
                                                    </div>
                                                    <div class="smallitem-toggle flex-v-center flex-h-center">
                                                        <div class="toggle_radio no-borders">
                                                            <input type="radio" {if $parameters.user->notification_type_23 == 1}checked {/if} class="toggle_option first" id="notification_type_230" name="notification_type_23" value="1" />
                                                            <label for="notification_type_230"><span>On</span></label>
                                                            <input type="radio" {if $parameters.user->notification_type_23 == 0}checked {/if} class="toggle_option second" id="notification_type_231" name="notification_type_23" value="0" />
                                                            <label for="notification_type_231"><span>Off</span></label>
                                                            <div class="toggle_option_slider"><span></span></div>
                                                        </div>
                                                    </div>
                                                </div>
