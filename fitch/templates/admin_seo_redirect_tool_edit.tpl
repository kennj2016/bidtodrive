...
<form class="validate" action="" method="post">
	<div class="section">
		...
		<div class="form-field">
			<div class="form-field-label-wrap">
				<div class="form-field-label">
					old url<span class="text-red"> *</span>
				</div>
			</div>
			<div class="form-field-input-wrap">
				<div class="form-field-input">
					<input type="text" class="input-text"  placeholder="old url" name="old_url" value="{$parameters.record->old_url|escape}"/>
				</div>
			</div>
		</div>
		...
		<div class="form-field">
			<div class="form-field-label-wrap">
				<div class="form-field-label">
					new url<span class="text-red"> *</span>
				</div>
			</div>
			<div class="form-field-input-wrap">
				<div class="form-field-input">
					<input type="text" class="input-text"  placeholder="new url" name="new_url" value="{$parameters.record->new_url|escape}"/>
				</div>
			</div>
		</div>
